...
Route::group(['prefix' => 'v1.0', 'namespace' => 'Api'], function() {
	...
	# Auth
	Route::post("signin", 'UserController@login')->middleware('throttle:api-auth');
	Route::post("signup", 'UserController@register')->middleware('throttle:api-auth');
	Route::post("signin/social", 'UserController@postSigninSocial')->middleware('throttle:api-auth');
	Route::post("signin/facebook", 'UserController@postSigninFacebook')->middleware('throttle:api-auth');
	Route::post("signin/twitter", 'UserController@postSigninTwitter')->middleware('throttle:api-auth');
	Route::post("forgot-password", 'UserController@postForgotpassword')->middleware('throttle:api-auth');
	...
	|
	*/
	Route::group(['middleware' => ['auth.api', 'track.device']], function() {
