...
Route::group(['middlewareGroups' => ['web']], function () {
    ...
    Route::group(['prefix' => 'ui/callback/payments', 'as' => 'ui-api.', 'namespace' => 'UserInterface\Api'], function() {
		Route::get('/return', 'PayPalController@returnCallback')->name('return-url');
		Route::get('/cancel', 'PayPalController@cancelCallback')->name('cancel-url');
		Route::get('/success', 'PayPalController@paymentSuccessful')->name('success');
		Route::get('/error', 'PayPalController@paymentFailed')->name('error');
	});
});